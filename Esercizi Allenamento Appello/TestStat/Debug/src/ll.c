...
# 19 "../../src/TestStat.c" 2
# 1 "/usr/local/include/ourhdr.h" 1 3
...
# 9 "/usr/local/include/ourhdr.h" 2 3
...
# 10 "/usr/local/include/ourhdr.h" 2 3
...
# 11 "/usr/local/include/ourhdr.h" 2 3
...
# 12 "/usr/local/include/ourhdr.h" 2 3
...
# 13 "/usr/local/include/ourhdr.h" 2 3
...
# 15 "/usr/local/include/ourhdr.h" 2 3
...
# 16 "/usr/local/include/ourhdr.h" 2 3
...
# 17 "/usr/local/include/ourhdr.h" 2 3
...
# 18 "/usr/local/include/ourhdr.h" 2 3
# 33 "/usr/local/include/ourhdr.h" 3
typedef void Sigfunc(int);
# 44 "/usr/local/include/ourhdr.h" 3
char *path_alloc(int *);
int open_max(void);
void clr_fl(int, int);
void set_fl(int, int);
...
# 97 "/usr/local/include/ourhdr.h" 3
...
int main(void) {
 int fd, i, a[10];
 char *file = "tempfile.bin";

 if ((fd = open( file, 
# 26 "../../src/TestStat.c" 3 4
                      01 
# 26 "../../src/TestStat.c"
                               | 
# 26 "../../src/TestStat.c" 3 4
...
# 26 "../../src/TestStat.c"
                                                  , 0664)) < 0)
  err_sys("Cannot opern file %s", file);

 for(i = 1; i <= 10; i++)
  a[i] = random();

 if (write(fd, &a, sizeof(a)) < 0)
   err_sys("Errore di scrittura array");

 if (lseek(fd, 10000000, 
# 35 "../../src/TestStat.c" 3 4
                        0
# 35 "../../src/TestStat.c"
                                ) < 0)
 ...
 if (stat( file, &buf) < 0)
  ...
  printf("DevId: %d\tINode number: %d\tMode: 0%o\n",
    buf.st_dev, buf.st_ino, buf.st_mode);
  printf("size: %ld\t#blocchi: %d x blockSize: %d (%ld)\n",
    buf.st_size, buf.st_blocks, buf.st_blksize, buf.st_blocks * 512L);
  printf("atime: %s\tmtime: %s\tctime: %s\n",
    ctime(&buf.
# 56 "../../src/TestStat.c" 3 4
              st_atim.tv_sec
# 56 "../../src/TestStat.c"
                      ), ctime(&buf.
# 56 "../../src/TestStat.c" 3 4
